...
"C:\Program Files (x86)\IAR Systems\Embedded Workbench 7.5\common\bin\cspybat" -f "C:\nxp\M4_trunc\system\iar\settings\m4_trunc.Debug.general.xcl" --backend -f "C:\nxp\M4_trunc\system\iar\settings\m4_trunc.Debug.driver.xcl" 
...
"C:\Program Files (x86)\IAR Systems\Embedded Workbench 7.5\common\bin\cspybat" -f "C:\nxp\M4_trunc\system\iar\settings\m4_trunc.Debug.general.xcl" "--debug_file=%~1" --backend -f "C:\nxp\M4_trunc\system\iar\settings\m4_trunc.Debug.driver.xcl" 
